    ...
    <div class="flex w-full max-w-5xl bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="w-1/2 p-10">
            ...
            <div class="mt-4 flex justify-center space-x-4">
                <button class="p-2 border rounded-full text-blue-500 hover:bg-white hover:text-red-500"><i class="fab fa-facebook-f"></i></button>
                <button class="p-2 border rounded-full text-red-500 hover:bg-white hover:text-red-500"><i class="fab fa-google"></i></button>
                <button class="p-2 border rounded-full text-black hover:bg-white hover:text-red-500"><i class="fab fa-tiktok"></i></button>
             </div>
            <p class="text-center text-gray-500 mb-4">or use your account</p>
            <form id="loginForm" class="space-y-4">
                <div>
                    <input type="text" id="username" name="username" placeholder="Username" required class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
